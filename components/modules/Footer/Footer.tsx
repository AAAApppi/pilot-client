                ...
                <div className={styles.footer__top}>
                    <div className={styles.footer__top__inner}>
                        <div className={styles.footer__top__item}>
                            {!isMedia500 && (
                                <>
                                    <h3 className={styles.footer__top__item__title}>
                                        Оброзовательная платформа Pilot
                                    </h3>
                                    <OnlineStoreContent />
                                </>
                            )}
                            {isMedia500 && (
                                <Accordion
                                    title="Оброзовательная платформа  Pilot"
                    ...
                    <div className={styles.footer__top__item}>
                        ...
                        <ul className={`${styles.footer__top__item__list} ${styles.footer__top__item__contacts}`}>
                            <li className={styles.footer__top__item__list__item}>
                                <Link href="/contacts" passHref legacyBehavior>
                                    <a className={styles.footer__top__item__list__item__link}>
                                        <span>Наш адрес</span>
                                        <span>Г. Комсомольск-на-амуре, ул Гамарника 16</span>
                                        <span><MarkerSvg /></span>
                                    </a>
                                </Link>
                            </li>
                            <li className={styles.footer__top__item__list__item}>
                                <a href='/tel:+79999999999' className={styles.footer__top__item__list__item__link}>
                            ...
                            <li className={styles.footer__top__item__list__item}>
                                <a href='mailto:ingo@gmail.com' className={styles.footer__top__item__list__item__link}>
                                    <span>E-mail</span>
                                    <span>ingo@gmail.com</span>
                                    <span><MailSvg /></span>
                                </a>
                            </li>
                        </ul>
                ...
                <div className={styles.footer__bottom}>
                    ...
                    <div className={styles.footer__bottom__block}>
                        <p className={styles.footer__bottom__block__copyright}>
                            © «Оброзовательная платформа» 2023.
                        </p>
                    </div>
                </div>
            </div>
